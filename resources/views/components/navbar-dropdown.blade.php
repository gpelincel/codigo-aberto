<div class="relative inline-block text-left">
    <button type="button" class="flex items-center gap-2 text-white hover:text-gray-200 focus:outline-none"
    ...
    <div id="user-dropdown"
        class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 text-gray-800">
        <a href="/ong/{{ session('user_id') }}" class="block px-4 py-2 text-sm hover:bg-gray-100">
            Meu Perfil
        </a>
